        ...
        <div className="grid gap-6 md:grid-cols-2">
          {reviews.map((review, i) => (
            <AnimatedSection key={review.name} delay={i * 0.12}>
              <div className="h-full rounded-2xl border border-vice-border bg-vice-card/50 p-8 transition-all duration-300 hover:border-vice-cyan/30 hover:shadow-[0_0_25px_rgba(0,240,255,0.08)]">
