        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          {steps.map((step, i) => (
            <div key={step.title} className="relative text-center">
              <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-full border border-vice-accent/30 bg-vice-card">
                <step.icon className="h-7 w-7 text-vice-accent" />
              </div>
              <span className="mb-2 inline-block text-xs font-bold uppercase tracking-wider text-vice-accent">
                Step {i + 1}
              </span>
